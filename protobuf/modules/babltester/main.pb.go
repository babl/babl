...
// source: modules/babltester/main.proto
// DO NOT EDIT!

/*
Package babl_babeltester is a generated protocol buffer package.

It is generated from these files:
	modules/babltester/main.proto

It has these top-level messages:
*/
package babl_babeltester
...
func (c *barClient) IO(ctx context.Context, in *babl.BinRequest, opts ...grpc.CallOption) (*babl.BinReply, error) {
	...
	err := grpc.Invoke(ctx, "/babl.babeltester.Bar/IO", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *barClient) Ping(ctx context.Context, in *babl.Empty, opts ...grpc.CallOption) (*babl.Pong, error) {
	out := new(babl.Pong)
	err := grpc.Invoke(ctx, "/babl.babeltester.Bar/Ping", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _Bar_serviceDesc = grpc.ServiceDesc{
	ServiceName: "babl.babeltester.Bar",
