...
// Client API for BablSh service

type BablShClient interface {
	IO(ctx context.Context, in *babl.BinRequest, opts ...grpc.CallOption) (*babl.BinReply, error)
	Ping(ctx context.Context, in *babl.Empty, opts ...grpc.CallOption) (*babl.Pong, error)
}

type bablShClient struct {
	cc *grpc.ClientConn
}

func NewBablShClient(cc *grpc.ClientConn) BablShClient {
	return &bablShClient{cc}
}

func (c *bablShClient) IO(ctx context.Context, in *babl.BinRequest, opts ...grpc.CallOption) (*babl.BinReply, error) {
	out := new(babl.BinReply)
	err := grpc.Invoke(ctx, "/babl.larskluge.BablSh/IO", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bablShClient) Ping(ctx context.Context, in *babl.Empty, opts ...grpc.CallOption) (*babl.Pong, error) {
	out := new(babl.Pong)
	err := grpc.Invoke(ctx, "/babl.larskluge.BablSh/Ping", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for BablSh service

type BablShServer interface {
	IO(context.Context, *babl.BinRequest) (*babl.BinReply, error)
	Ping(context.Context, *babl.Empty) (*babl.Pong, error)
}

func RegisterBablShServer(s *grpc.Server, srv BablShServer) {
	s.RegisterService(&_BablSh_serviceDesc, srv)
}

func _BablSh_IO_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(babl.BinRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(BablShServer).IO(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BablSh_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(babl.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(BablShServer).Ping(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _BablSh_serviceDesc = grpc.ServiceDesc{
	ServiceName: "babl.larskluge.BablSh",
	HandlerType: (*BablShServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "IO",
			Handler:    _BablSh_IO_Handler,
		},
		{
			MethodName: "Ping",
			Handler:    _BablSh_Ping_Handler,
		},
	},
	Streams: []grpc.StreamDesc{},
}
...
// Client API for HelloWeb service

type HelloWebClient interface {
	IO(ctx context.Context, in *babl.BinRequest, opts ...grpc.CallOption) (*babl.BinReply, error)
	Ping(ctx context.Context, in *babl.Empty, opts ...grpc.CallOption) (*babl.Pong, error)
}

type helloWebClient struct {
	cc *grpc.ClientConn
}

func NewHelloWebClient(cc *grpc.ClientConn) HelloWebClient {
	return &helloWebClient{cc}
}

func (c *helloWebClient) IO(ctx context.Context, in *babl.BinRequest, opts ...grpc.CallOption) (*babl.BinReply, error) {
	out := new(babl.BinReply)
	err := grpc.Invoke(ctx, "/babl.larskluge.HelloWeb/IO", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloWebClient) Ping(ctx context.Context, in *babl.Empty, opts ...grpc.CallOption) (*babl.Pong, error) {
	out := new(babl.Pong)
	err := grpc.Invoke(ctx, "/babl.larskluge.HelloWeb/Ping", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for HelloWeb service

type HelloWebServer interface {
	IO(context.Context, *babl.BinRequest) (*babl.BinReply, error)
	Ping(context.Context, *babl.Empty) (*babl.Pong, error)
}

func RegisterHelloWebServer(s *grpc.Server, srv HelloWebServer) {
	s.RegisterService(&_HelloWeb_serviceDesc, srv)
}

func _HelloWeb_IO_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(babl.BinRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(HelloWebServer).IO(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloWeb_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(babl.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(HelloWebServer).Ping(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _HelloWeb_serviceDesc = grpc.ServiceDesc{
	ServiceName: "babl.larskluge.HelloWeb",
	HandlerType: (*HelloWebServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "IO",
			Handler:    _HelloWeb_IO_Handler,
		},
		{
			MethodName: "Ping",
			Handler:    _HelloWeb_Ping_Handler,
		},
	},
	Streams: []grpc.StreamDesc{},
}
...
// Client API for LoyalistS3UploadBackend service

type LoyalistS3UploadBackendClient interface {
	IO(ctx context.Context, in *babl.BinRequest, opts ...grpc.CallOption) (*babl.BinReply, error)
	Ping(ctx context.Context, in *babl.Empty, opts ...grpc.CallOption) (*babl.Pong, error)
}

type loyalistS3UploadBackendClient struct {
	cc *grpc.ClientConn
}

func NewLoyalistS3UploadBackendClient(cc *grpc.ClientConn) LoyalistS3UploadBackendClient {
	return &loyalistS3UploadBackendClient{cc}
}

func (c *loyalistS3UploadBackendClient) IO(ctx context.Context, in *babl.BinRequest, opts ...grpc.CallOption) (*babl.BinReply, error) {
	out := new(babl.BinReply)
	err := grpc.Invoke(ctx, "/babl.larskluge.LoyalistS3UploadBackend/IO", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loyalistS3UploadBackendClient) Ping(ctx context.Context, in *babl.Empty, opts ...grpc.CallOption) (*babl.Pong, error) {
	out := new(babl.Pong)
	err := grpc.Invoke(ctx, "/babl.larskluge.LoyalistS3UploadBackend/Ping", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for LoyalistS3UploadBackend service

type LoyalistS3UploadBackendServer interface {
	IO(context.Context, *babl.BinRequest) (*babl.BinReply, error)
	Ping(context.Context, *babl.Empty) (*babl.Pong, error)
}

func RegisterLoyalistS3UploadBackendServer(s *grpc.Server, srv LoyalistS3UploadBackendServer) {
	s.RegisterService(&_LoyalistS3UploadBackend_serviceDesc, srv)
}

func _LoyalistS3UploadBackend_IO_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(babl.BinRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(LoyalistS3UploadBackendServer).IO(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LoyalistS3UploadBackend_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(babl.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(LoyalistS3UploadBackendServer).Ping(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _LoyalistS3UploadBackend_serviceDesc = grpc.ServiceDesc{
	ServiceName: "babl.larskluge.LoyalistS3UploadBackend",
	HandlerType: (*LoyalistS3UploadBackendServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "IO",
			Handler:    _LoyalistS3UploadBackend_IO_Handler,
		},
		{
			MethodName: "Ping",
			Handler:    _LoyalistS3UploadBackend_Ping_Handler,
		},
	},
	Streams: []grpc.StreamDesc{},
}
