...
// source: github.com/larskluge/babl/protobuf/modules/alt_f4/main.proto
// DO NOT EDIT!

/*
Package babl_alt_f4 is a generated protocol buffer package.

It is generated from these files:
	github.com/larskluge/babl/protobuf/modules/alt_f4/main.proto
...
func (c *testClient) IO(ctx context.Context, in *babl.BinRequest, opts ...grpc.CallOption) (*babl.BinReply, error) {
	...
	err := grpc.Invoke(ctx, "/babl.alt_f4.Test/IO", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testClient) Ping(ctx context.Context, in *babl.Empty, opts ...grpc.CallOption) (*babl.Pong, error) {
	out := new(babl.Pong)
	err := grpc.Invoke(ctx, "/babl.alt_f4.Test/Ping", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
