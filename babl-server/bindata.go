...
func dataServerKey() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/server.key", size: 887, mode: os.FileMode(420), modTime: time.Unix(1446813769, 0)}
...
func dataServerPem() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/server.pem", size: 964, mode: os.FileMode(420), modTime: time.Unix(1446813769, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
