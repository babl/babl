...
var _dataVersion = []byte("\x1f\x8b\x08\x00\x00\x09\x6e\x88\x00\xff\x32\xd0\x33\xd2\x33\xe3\x02\x04\x00\x00\xff\xff\xc0\x14\x71\xca\x06\x00\x00\x00")
...
func dataVersion() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/VERSION", size: 6, mode: os.FileMode(420), modTime: time.Unix(1456743462, 0)}
